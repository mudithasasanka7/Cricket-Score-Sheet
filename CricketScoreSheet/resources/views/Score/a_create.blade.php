...
@endif
    ...
    <div class="container mt-2">
        ...
        <div class="container mt-2">
            ...
            <div class="container">
                <input type="radio" name="postures" value="batting" class="btn-check" id="">
                <label class="form-check-label" for="inlineCheckbox1">Batting</label><br>
                <input type="radio" name="postures" value="balling" class="btn-check" id="">
                <label class="form-check-label" for="inlineCheckbox1">Balling</label><br>
                <input type="radio" name="postures" value="3X Action" class="btn-check" id="">
