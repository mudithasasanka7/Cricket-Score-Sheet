...
@section('contend')
    <form action="#" method="post">
        ...
        <table class="tab">
            <tr>
                <td>
                    <input type="text" value="0" size="3" disabled id="runs" >
                </td>
                <td>
                    <input type="text" value="0" size="2" disabled id="11">
                </td>
                <td>
                    <input type="text" value="0.0" size="5" id="overs" disabled >
                </td>
                <td>
        ...
        <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; margin: 0;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" disabled size="3" value="0">
                </td>
                <td>
                    <input type="text" disabled size="3" value="0">
                </td>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" disabled value="0.00" id="runratetext">
                </td>
                <td class="text">
                    Extra :
                </td>
                <td>
                    <input type="text" disabled value="0" id="extramarks">
                </td>
                <td class="text">
                    Target Runs :
                </td>
                <td>
                    <input type="text" disabled value="0" id="target">
                </td>
            </tr>
        </table>
            
        <!-- <textarea name="textView" value="" id="demo" cols="170" rows="1" disabled placeholder="This Balls..."></textarea> -->
        <hr>
        <table>
            <tr>
                <th class="th5">
                ...
                <td>
                    <input type="button" value="Rn 0" class="button" id="disableid37"  onclick="updateRuns(0)">
                </td>
                <td>
                    <input type="button" value="Rn 1" class="button" id="disableid38"  onclick="updateRuns(1)">
                </td>
                <td>
                    <input type="button" value="Rn 2" class="button" id="disableid39"  onclick="updateRuns(2)">
                </td>
                <td>
                    <input type="button" value="Rn 3" class="button" id="disableid40"  onclick="updateRuns(3)">
                </td>
                <td>
                    <input type="button" value="Rn 4" class="button" id="disableid41"  onclick="updateRuns(4)">
                </td>
                <td>
                    <input type="button" value="Rn 6" class="button" id="disableid42"  onclick="updateRuns(6)">
                </td>
            </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="By 0" class="button" id="disableid29"  onclick="updateRuns(-1)">
                    </td>
                    <td>
                        <input type="button" value="By 1" class="button" id="disableid30"  onclick="updateRuns(-2)">
                    </td>
                    <td>
                        <input type="button" value="By 2" class="button" id="disableid31"  onclick="updateRuns(-3)">
                    </td>
                    <td>
                        <input type="button" value="By 3" class="button" id="disableid32"  onclick="updateRuns(-4)">
                    </td>
                    <td>
                        <input type="button" value="By 4" class="button" id="disableid33"  onclick="updateRuns(-5)">
                    </td>
                    <td>
                        <input type="button" value="By 5" class="button" id="disableid34"  onclick="updateRuns(-6)">
                    </td>
                    <td>
                        <input type="button" value="By 6" class="button" id="disableid35"  onclick="updateRuns(-7)">
                    </td>
                    <td>
                        <input type="button" value="By 7" class="button" id="disableid36"  onclick="updateRuns(-8)">
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="LB 0" class="button" id="disableid21" onclick="updateRuns(-9)">
                    </td>
                    <td>
                        <input type="button" value="LB 1" class="button" id="disableid22" onclick="updateRuns(-10)">
                    </td>
                    <td>
                        <input type="button" value="LB 2" class="button" id="disableid23" onclick="updateRuns(-11)">
                    </td>
                    <td>
                        <input type="button" value="LB 3" class="button" id="disableid24" onclick="updateRuns(-12)">
                    </td>
                    <td>
                        <input type="button" value="LB 4" class="button" id="disableid25" onclick="updateRuns(-13)">
                    </td>
                    <td>
                        <input type="button" value="LB 5" class="button" id="disableid26" onclick="updateRuns(-14)">
                    </td>
                    <td>
                        <input type="button" value="LB 6" class="button" id="disableid27" onclick="updateRuns(-15)">
                    </td>
                    <td>
                        <input type="button" value="LB 7" class="button" id="disableid28" onclick="updateRuns(-16)">
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="NB" class="button" id="disableid15" onclick="updateRuns(-17)">
                    </td>
                    <td>
                        <input type="button" value="N Ru1" class="button" id="disableid16" onclick="updateRuns(-18)">
                    </td>
                    <td>
                        <input type="button" value="N Ru2" class="button" id="disableid17" onclick="updateRuns(-19)">
                    </td>
                    <td>
                        <input type="button" value="N Ru3" class="button" id="disableid18" onclick="updateRuns(-20)">
                    </td>
                    <td>
                        <input type="button" value="N Ru4" class="button" id="disableid19" onclick="updateRuns(-21)">
                    </td>
                    <td>
                        <input type="button" value="NB Ru6" class="button" id="disableid20" onclick="updateRuns(-22)">
                    </td>
                </tr>
        </table>
        <table>
            <tr>
                ...
                <td>
                    <input type="button" value="Run OUT" class="button" id="disableid5" onclick="wickets(1)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 1" class="button" id="disableid6" onclick="wickets(3)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 2" class="button" id="disableid7" onclick="wickets(4)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 3" class="button" id="disableid8" onclick="wickets(5)">
                </td>
                <td>
                    <input type="button" value="Stump" class="button" id="disableid9" onclick="wickets(1)">
                </td>
                <td>
                    <input type="button" value="LBW" class="button" id="disableid10" onclick="wickets(1)">
                </td>
                <td>
                    <input type="button" value="Catch" class="button" id="disableid11" onclick="wickets(1)">
                </td>
                <td>
                    <input type="button" value="Hit Witcket" class="button" id="disableid12" onclick="wickets(1)">
                </td>
                <td>
                    <input type="button" value="Wide Run OUT" class="button red" id="disableid13" onclick="wickets(2)">
                </td>
                <td>
                    <input type="button" value="Wide Stump" class="button red" id="disableid14" onclick="wickets(2)">
                </td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <td>
                    <input type="button" value="Wide" class="button" id="disableid" onclick="updateRuns(-24)">
                </td>
                <td>
                    <input type="button" value="Wd Ru1" class="button red" id="disableid1" onclick="updateRuns(-25)">
                </td>
                <td>
                    <input type="button" value="Wd Ru2" class="button red" id="disableid2" onclick="updateRuns(-26)">
                </td>
                <td>
                    <input type="button" value="Wd Ru3" class="button red" id="disableid3" onclick="updateRuns(-27)">
                </td>
                <td>
                    <input type="button" value="Wd Ru4" class="button red" id="disableid4" onclick="updateRuns(-28)">
                </td>
            </tr>
        </table>
        <p id="demo">This Over {</p>
            <!-- <p>This Overs: </p> -->
        <!-- <textarea name="textView" value="" id="demo" cols="170" rows="1" disabled placeholder="This Balls..."></textarea> -->
        <p id="demo1"></p>
            <div>
                <input type="button" value="Team 1 Finish" id="resers" class="button" onclick="finish()">
            </div>
    </form>
    ...
    <form>
        ...
        <table>
            <tr>
                ...
                <td>
                    <input type="text" disabled value="0.00" id="oprunratetext">
                </td>
                <td class="text">
                    Extra :
                </td>
                <td>
                    <input type="text" disabled value="0" id="opextramarks">
                </td>
                <td class="text">
                    Target Runs :
                </td>
                <td>
                    <input type="text" disabled value="0" id="optarget">
                </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                ...
                <td>
                    <input type="button" value="Rn 0" class="button" id="disableid87" disabled onclick="opupdateRuns(0)">
                </td>
                <td>
                    <input type="button" value="Rn 1" class="button" id="disableid88" disabled onclick="opupdateRuns(1)">
                </td>
                <td>
                    <input type="button" value="Rn 2" class="button" id="disableid89" disabled onclick="opupdateRuns(2)">
                </td>
                <td>
                    <input type="button" value="Rn 3" class="button" id="disableid90" disabled onclick="opupdateRuns(3)">
                </td>
                <td>
                    <input type="button" value="Rn 4" class="button" id="disableid91" disabled onclick="opupdateRuns(4)">
                </td>
                <td>
                    <input type="button" value="Rn 6" class="button" id="disableid92" disabled onclick="opupdateRuns(6)">
                </td>
            </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="By 0" class="button" id="disableid79" disabled onclick="opupdateRuns(-1)">
                    </td>
                    <td>
                        <input type="button" value="By 1" class="button" id="disableid80" disabled onclick="opupdateRuns(-2)">
                    </td>
                    <td>
                        <input type="button" value="By 2" class="button" id="disableid81"disabled  onclick="opupdateRuns(-3)">
                    </td>
                    <td>
                        <input type="button" value="By 3" class="button" id="disableid82" disabled onclick="opupdateRuns(-4)">
                    </td>
                    <td>
                        <input type="button" value="By 4" class="button" id="disableid83" disabled onclick="opupdateRuns(-5)">
                    </td>
                    <td>
                        <input type="button" value="By 5" class="button" id="disableid84" disabled onclick="opupdateRuns(-6)">
                    </td>
                    <td>
                        <input type="button" value="By 6" class="button" id="disableid85" disabled onclick="opupdateRuns(-7)">
                    </td>
                    <td>
                        <input type="button" value="By 7" class="button" id="disableid86"disabled  onclick="opupdateRuns(-8)">
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="LB 0" class="button" id="disableid71"disabled onclick="opupdateRuns(-9)">
                    </td>
                    <td>
                        <input type="button" value="LB 1" class="button" id="disableid72"disabled onclick="opupdateRuns(-10)">
                    </td>
                    <td>
                        <input type="button" value="LB 2" class="button" id="disableid73"disabled onclick="opupdateRuns(-11)">
                    </td>
                    <td>
                        <input type="button" value="LB 3" class="button" id="disableid74"disabled onclick="opupdateRuns(-12)">
                    </td>
                    <td>
                        <input type="button" value="LB 4" class="button" id="disableid75"disabled onclick="opupdateRuns(-13)">
                    </td>
                    <td>
                        <input type="button" value="LB 5" class="button" id="disableid76"disabled onclick="opupdateRuns(-14)">
                    </td>
                    <td>
                        <input type="button" value="LB 6" class="button" id="disableid77"disabled onclick="opupdateRuns(-15)">
                    </td>
                    <td>
                        <input type="button" value="LB 7" class="button" id="disableid78"disabled onclick="opupdateRuns(-16)">
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="button" value="NB" class="button" id="disableid65"disabled onclick="opupdateRuns(-17)">
                    </td>
                    <td>
                        <input type="button" value="N Ru1" class="button" id="disableid66"disabled onclick="opupdateRuns(-18)">
                    </td>
                    <td>
                        <input type="button" value="N Ru2" class="button" id="disableid67"disabled onclick="opupdateRuns(-19)">
                    </td>
                    <td>
                        <input type="button" value="N Ru3" class="button" id="disableid68"disabled onclick="opupdateRuns(-20)">
                    </td>
                    <td>
                        <input type="button" value="N Ru4" class="button" id="disableid69"disabled onclick="opupdateRuns(-21)">
                    </td>
                    <td>
                        <input type="button" value="NB Ru6" class="button" id="disableid70"disabled onclick="opupdateRuns(-22)">
                    </td>
                </tr>
        </table>
        <table>
            <tr>
                ...
                <td>
                    <input type="button" value="Run OUT" class="button" id="disableid55" disabled onclick="opwickets(1)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 1" class="button" id="disableid56" disabled onclick="opwickets(3)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 2" class="button" id="disableid57" disabled onclick="opwickets(4)">
                </td>
                <td>
                    <input type="button" value="Run OUT + 3" class="button" id="disableid58" disabled onclick="opwickets(5)">
                </td>
                <td>
                    <input type="button" value="Stump" class="button" id="disableid59" disabled onclick="opwickets(1)">
                </td>
                <td>
                    <input type="button" value="LBW" class="button" id="disableid60" disabled onclick="opwickets(1)">
                </td>
                <td>
                    <input type="button" value="Catch" class="button" id="disableid61" disabled onclick="opwickets(1)">
                </td>
                <td>
                    <input type="button" value="Hit Witcket" class="button" id="disableid62" disabled onclick="opwickets(1)">
                </td>
                <td>
                    <input type="button" value="Wide Run OUT" class="button red" id="disableid63" disabled onclick="opwickets(2)">
                </td>
                <td>
                    <input type="button" value="Wide Stump" class="button red" id="disableid64" disabled onclick="opwickets(2)">
                </td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <td>
                    <input type="button" value="Wide" class="button" id="disableid50" disabled onclick="opupdateRuns(-24)">
                </td>
                <td>
                    <input type="button" value="Wd Ru1" class="button red" id="disableid51" disabled onclick="opupdateRuns(-25)">
                </td>
                <td>
                    <input type="button" value="Wd Ru2" class="button red" id="disableid52" disabled onclick="opupdateRuns(-26)">
                </td>
                <td>
                    <input type="button" value="Wd Ru3" class="button red" id="disableid53" disabled onclick="opupdateRuns(-27)">
                </td>
                <td>
                    <input type="button" value="Wd Ru4" class="button red" id="disableid54" disabled onclick="opupdateRuns(-28)">
                </td>
            </tr>
        </table>
        <p id="opdemo">This Over {</p>
            <!-- <p>This Overs: </p> -->
        <!-- <textarea name="textView" value="" id="demo" cols="170" rows="1" disabled placeholder="This Balls..."></textarea> -->
        <p id="demo1"></p>
            <div>
                <input type="button" value="END the Match" id="opresers" class="button" onclick="opfinish()">
            </div>
